...
const Work = ({isDarkMode}) => {
  return (
    ...
    id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      Welcome to my  DEV portfolio! Explore a collection of projects showcasing my expertise in Software Engineering, Full-stack development and Data Engineering.</motion.p>
